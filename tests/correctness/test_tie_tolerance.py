...
def test_small_top2_gap_does_not_excuse_a_far_off_fast_token() -> None:
    """The hardened bar: a near-tie between the top two does NOT bless a third, far-down token.

    Regression for a gate that accepted any divergence whenever the reference top-2 gap was
