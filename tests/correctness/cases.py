"""The golden cases: a few short text-to-SQL prompts kept tiny so the reference check runs on CPU.
...
schemas small and ``max_new_tokens`` short — the point is a fast, exact reference check, not
