"""Single-request greedy decode: the backend-independent reference check path.

No batching, no KV-cache — each step re-runs the full forward over the growing
sequence and takes the argmax. Slow, exact, and intentionally simple: this is the
reference path.
"""
