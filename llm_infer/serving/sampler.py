...
requests happen to share the decode batch. That independence is the load-bearing honesty
property: a sampled request produces the **identical** sequence run alone or batched with
...
class SamplingParams:
    ...
    def is_greedy(self) -> bool:
        """Whether this request decodes greedily (temperature 0) — the proven oracle path."""
        return self.temperature == 0.0


# The engine's default sampling: greedy, token-for-token the proven oracle path.
