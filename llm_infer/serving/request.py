...
semantics mirror the reference check ``greedy_decode`` exactly (EOS token included, capped at
...
class Request:
    ...
    def reset_for_recompute(self) -> None:
        ...
        the trace stays clear); it only clears the request's view of its cache so a fresh
